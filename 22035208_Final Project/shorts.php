...
<body>
    ...
    <section class="product-details">
        <div class="product-image">
            <img src="img/shorts1.jpeg">
        </div>

        <div class="details">
            <h2 class="product-des">Cotton</h2>
            <p class="product-short-des">Cotton<br>A red cotton shorts</p>
            <span class="product-price">RM10</span>
            <span class="product-act-price">RM20</span>
    ...
    <section class="product">
        <h2 class="product-category">More Shorts</h2>
