...
<body>
    ...
    <section class="product-details">
        ...
        <div class="details">
            ...
            <p class="product-short-des">Cotton<br>A grey cotton jacket</p>
            <span class="product-price">RM20</span>
            <span class="product-act-price">RM40</span>
    ...
    <section class="product">
        <h2 class="product-category">More Jacket</h2>
